...
if __name__ == '__main__':
  ...
  [init_x, init_y, init_z, init_w] = quaternion_from_euler(-1,-1,-1)
  pcs.pose.pose.orientation.x = init_x
  pcs.pose.pose.orientation.y = init_y
  pcs.pose.pose.orientation.z = init_z
  pcs.pose.pose.orientation.w = init_w
  rospy.sleep(1.0) 
